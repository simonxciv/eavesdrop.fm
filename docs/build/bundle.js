    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			input = element("input");
    			add_location(h4, file, 47, 8, 1871);
    			add_location(br, file, 48, 90, 1977);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "e.g. simon");
    			add_location(input, file, 49, 8, 1990);
    			add_location(div, file, 46, 7, 1841);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file, 54, 8, 2142);
    			attr_dev(i, "class", "fas fa-clone");
    			add_location(i, file, 56, 9, 2265);
    			attr_dev(button, "id", "copier");
    			attr_dev(button, "class", "btn");
    			attr_dev(button, "data-clipboard-text", /*url*/ ctx[2]);
    			add_location(button, file, 55, 8, 2166);
    			add_location(div, file, 53, 7, 2112);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h4);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file, 57, 86, 2398);
    			attr_dev(span, "class", "clipboardsuccess");
    			add_location(span, file, 57, 39, 2351);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file, 62, 8, 2558);
    			attr_dev(a, "href", "https://app.plex.tv/desktop#!/settings/webhooks");
    			add_location(a, file, 63, 54, 2628);
    			add_location(div, file, 61, 7, 2528);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h4);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			i2 = element("i");
    			attr_dev(a0, "href", "/");
    			add_location(a0, file, 21, 5, 465);
    			add_location(h1, file, 20, 4, 455);
    			attr_dev(i0, "class", "fas fa-heart");
    			add_location(i0, file, 23, 29, 533);
    			add_location(p0, file, 23, 4, 508);
    			attr_dev(div0, "class", "grid");
    			add_location(div0, file, 19, 3, 432);
    			attr_dev(a1, "href", "https://plex.tv");
    			add_location(a1, file, 25, 19, 595);
    			attr_dev(a2, "href", "https://listenbrainz.org");
    			add_location(a2, file, 25, 82, 658);
    			add_location(h3, file, 25, 3, 579);
    			attr_dev(header, "class", "justified");
    			add_location(header, file, 18, 2, 402);
    			add_location(h20, file, 30, 5, 805);
    			add_location(p1, file, 31, 5, 838);
    			add_location(div1, file, 29, 4, 794);
    			...
    			add_location(img, file, 33, 4, 1058);
    			attr_dev(section0, "class", "about grid justified");
    			add_location(section0, file, 28, 3, 751);
    			add_location(h21, file, 37, 5, 1217);
    			attr_dev(a3, "href", "https://www.plex.tv/your-media/music/");
    			add_location(a3, file, 38, 54, 1292);
    			attr_dev(a4, "href", "https://www.plex.tv/plex-pass/");
    			add_location(a4, file, 38, 131, 1369);
    			attr_dev(a5, "href", "https://musicbrainz.org/register");
    			add_location(a5, file, 38, 198, 1436);
    			add_location(p2, file, 38, 5, 1243);
    			add_location(h40, file, 41, 7, 1538);
    			attr_dev(a6, "href", "https://listenbrainz.org/profile/");
    			add_location(a6, file, 42, 18, 1572);
    			add_location(br, file, 42, 142, 1696);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "e.g. 152be636-bc70-4c86-9d0d-ba5bfb79fb65");
    			add_location(input, file, 43, 7, 1708);
    			add_location(div2, file, 40, 6, 1525);
    			add_location(div3, file, 39, 5, 1513);
    			attr_dev(div4, "class", "justified");
    			add_location(div4, file, 36, 4, 1188);
    			attr_dev(section1, "class", "get-started");
    			add_location(section1, file, 35, 3, 1154);
    			add_location(h22, file, 70, 4, 2837);
    			add_location(h41, file, 72, 4, 2855);
    			attr_dev(a7, "href", "https://www.plex.tv/plex-labs/#section7");
    			add_location(a7, file, 73, 35, 2926);
    			add_location(p3, file, 73, 4, 2895);
    			add_location(h42, file, 75, 4, 3086);
    			attr_dev(a8, "href", "https://listenbrainz.org/profile/");
    			add_location(a8, file, 76, 67, 3199);
    			add_location(p4, file, 76, 4, 3136);
    			add_location(h43, file, 78, 4, 3305);
    			add_location(p5, file, 79, 4, 3356);
    			add_location(h44, file, 81, 4, 3579);
    			add_location(p6, file, 82, 4, 3633);
    			add_location(li0, file, 84, 5, 3675);
    			attr_dev(a9, "href", "https://app.plex.tv/desktop#!/settings/webhooks");
    			add_location(a9, file, 85, 38, 3799);
    			add_location(li1, file, 85, 5, 3766);
    			add_location(li2, file, 86, 5, 3889);
    			add_location(li3, file, 87, 5, 4019);
    			add_location(ul, file, 83, 4, 3665);
    			attr_dev(a10, "title", "Eavesdrop.FM on Github");
    			attr_dev(a10, "href", "https://github.com/simonxciv/eavesdrop.fm");
    			add_location(a10, file, 89, 100, 4186);
    			add_location(p7, file, 89, 4, 4090);
    			add_location(h45, file, 91, 4, 4325);
    			add_location(strong, file, 92, 10, 4367);
    			add_location(p8, file, 92, 4, 4361);
    			attr_dev(section2, "class", "faq justified");
    			add_location(section2, file, 69, 3, 2801);
    			add_location(main, file, 27, 2, 741);
    			attr_dev(div5, "id", "home");
    			attr_dev(div5, "class", "content");
    			add_location(div5, file, 17, 1, 368);
    			attr_dev(i1, "class", "fad fa-hammer");
    			add_location(i1, file, 99, 4, 4641);
    			attr_dev(a11, "href", "https://smnbkly.co");
    			add_location(a11, file, 99, 43, 4680);
    			add_location(div6, file, 98, 3, 4631);
    			attr_dev(i2, "class", "fab fa-github");
    			add_location(i2, file, 103, 5, 4854);
    			attr_dev(a12, "title", "Eavesdrop.FM on Github");
    			attr_dev(a12, "href", "https://github.com/simonxciv/eavesdrop.fm");
    			add_location(a12, file, 102, 4, 4765);
    			attr_dev(div7, "class", "github");
    			add_location(div7, file, 101, 3, 4740);
    			attr_dev(div8, "class", "grid");
    			add_location(div8, file, 97, 2, 4609);
    			attr_dev(footer, "class", "justified");
    			add_location(footer, file, 96, 1, 4580);
    			attr_dev(div9, "id", "swup");
    			attr_dev(div9, "class", "transition-fade");
